...
```nix
{
  inputs = {
    ...
    inspr-modules.url = "github:inspr-at/inspr-modules/v0.4.3";
...
**v0.4.3.** Extracted from a working NixOS + Home Manager fleet on 2026-05-02
...
git -C doctrine checkout v0.4.3
