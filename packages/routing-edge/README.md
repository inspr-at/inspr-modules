...
`inspr-modules` before consumers pin an immutable coordinate. The consumer example below targets `v0.10.0`; use it after the matching
...
```nix
inputs.inspr-modules.url = "github:inspr-at/inspr-modules/v0.10.0";
